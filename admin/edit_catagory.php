...
include '../conn.php';
$id = $_GET['id'];
$sql = "SELECT * FROM `tbl_add_catagory` WHERE `catagory_Id` = '$id'";
...
if(isset($_POST['update_cat']))
{
 ...
 $old_img = $_POST['old_img'];
    ...
    $query = "UPDATE `tbl_add_catagory` SET  `catagory_Id` ='$id',`catagory_cover` = '$cat_cover', `catagory_title` = '$cat_title' WHERE `catagory_Id` = '$id'";
